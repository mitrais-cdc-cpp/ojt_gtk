                                  ...
                                  guchar    **data)
{
  ...
  *actual_format = 8 * width;
  ...
  if (offset + length > width * mir_property->array->len)
    length = width * mir_property->array->len - offset;
              ...
              gint           n_requested_targets)
{
  ...
  g_byte_array_free (paste_data, TRUE);
  g_array_free (paste_header, TRUE);
  g_ptr_array_free (paste_formats, TRUE);
}
